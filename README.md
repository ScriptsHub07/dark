...
local Window = OrionLib:MakeWindow({Name = "Dark Hub", HidePremium = false, IntroText = "Loading Dark Hub...", SaveConfig = false, ConfigFolder = "Dark Hub"})

OrionLib:MakeNotification({
	Name = "Dark Hub",
	Content = "Melhor Script esta sendo carregado",
	Image = "rbxassetid://111405391826275",
	Time = 15
})

OrionLib:MakeNotification({
    Name = "Dark Hub",
    Content = "Por Favor Espere...Carregando Script",
    Image = "",
    Time = 5
})
...
W:AddLabel("[+] Dark Hub o Melhor de Todos")
W:AddLabel("[+] Melhor Auto Farm Anti Ban")
W:AddLabel("[+] Upe mais Rapido")
W:AddLabel("[+] Script Leve")
...
local AttackList = {"0.5", "0.55", "0.6", "0.65", "0.7", "0.75", "0.8", "0.85", "0.9", "0.95", "1"}
M:AddDropdown({
...
spawn(function()
    while wait(.1) do
        if _G.FastAttackDelay then
            pcall(function()
                if _G.FastAttackDelay == "0.5" then
...
OrionLib:MakeNotification({
        Name = "Dark Hub",
        Content = "Carregamento do script completado",
        Image = "",
        Time = 5
    })
...
OrionLib:MakeNotification({
    Name = "Dark Hub",
    Content = "Carregamento Completado!!",
    Image = "",
    Time = 5
})
